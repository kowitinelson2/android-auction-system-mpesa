...
import com.example.myapplication2_1.LoginFragment.LoginCallbacks;
import com.example.myapplication2_1.LoginFragment;


public class MainActivity extends OrmActivity implements LoginCallbacks, SignupFragment.SignupCallbacks {
    ...
    private class SplashTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            long userId = Long.parseLong(prefManager.readPreference(Constants.PREF_LOGGED_USER_ID, "-1"));
            boolean remember = Boolean.parseBoolean(prefManager.readPreference(Constants.PREF_REMEMBER_ME, "false"));
